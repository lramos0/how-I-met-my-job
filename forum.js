...
(function () {
  ...
  function renderHub() {
    ...
    root.innerHTML = '<div class="reddit-top"><a href="#" class="reddit-back">&larr; Job listings</a><div class="reddit-hub-title"><h1>Company forums</h1><p>Choose a company, start threads, comment, and vote. Firebase turns this into shared public forum data; local mode remains available for development.</p></div><div class="forum-co-search-wrap"><span class="forum-co-search-icon">r/</span><input type="search" class="forum-co-search" id="forumHubSearch" placeholder="Search companies..." autocomplete="off"><ul class="forum-co-results" id="forumHubResults"></ul></div></div><div class="reddit-hub-grid">' + cards + '</div>';
